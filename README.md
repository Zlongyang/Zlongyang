...
- 🎓 南京邮电大学 **25级 网络工程** 在读，追在技术潮流第一线
- 🤖 正在深入 **LLM Agent** 方向，了解 DeepSeekHarness、Pi Agent 等智能体框架
- 🔍 对 **RAG**、**AIGC**、**具身智能（Embodied AI）** 抱有浓厚兴趣
- 🚢 罗德岛在职博士 —— 《明日方舟》老玩家
- 💡 信条：**动手做出来，比看一百篇博客都有用**
...
![LLM](https://img.shields.io/badge/-LLM_Agent-412991?style=flat-square&logo=openai&logoColor=white)
![RAG](https://img.shields.io/badge/-RAG-FF6B6B?style=flat-square)
![AIGC](https://img.shields.io/badge/-AIGC-1DB954?style=flat-square)
![Embodied AI](https://img.shields.io/badge/-%E5%85%B7%E8%BA%AB%E6%99%BA%E8%83%BD-0A66C2?style=flat-square)
...
- [x] 独立完成一个完整的 RAG 项目 ✅
- [x] 深入 Agent 架构：规划、记忆、工具调用、多智能体协作 ✅
- [ ] 跟进具身智能前沿（VLA、World Model）
- [ ] 尝试微调 / RLHF 实践
